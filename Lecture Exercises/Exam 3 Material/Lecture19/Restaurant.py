...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 12 14:57:03 2021

@author: maxrueda
11/12/21
CSCI 1100
Lect. Exercises 19.1 - Restaurant.py Class
"""

"""
1. The Restaurant.py file you were provided along with Lecture 19 includes a
    main code area with code to test functions that have not yet been written
    (see the methods with pass as their only statements). These are the
    min_review, the max_review, the latitude and the longitude. Please
    implement these functions, test them, and submit the resulting
    Restaurant.py.
"""
