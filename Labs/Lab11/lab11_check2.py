...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 30 12:43:27 2021
...
class BallDraw(object):
    def __init__ (self, parent, ballObject):
        ...
        self.ball_x,self.ball_y = ballObject.xCoord,ballObject.yCoord    # initial location
        self.ball_radius = ballObject.rad
        self.ball_dx,self.ball_dy = ballObject.dxVal, ballObject.dyVal    # the movement of the ball object
        self.ball_color = ballObject.color
    ...
    def animate(self):
       ...
       while ballObject.some_inside(self.maxx, self.maxy):
       """
        while True:
            # Move the ball
            self.draw_ball()
            self.ball.move(self.maxx, self.maxy)
            self.ball_x, self.ball_y = self.ball.position()
...
if __name__ == "__main__":
    ...
    ballObject = Ball(190,100,-10,18,25,'green')
    bd = BallDraw(root, ballObject)
